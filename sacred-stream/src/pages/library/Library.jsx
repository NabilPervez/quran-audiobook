...
const TABS = [
  ...
  { to: '/library/downloads', label: 'Downloads' },
];
...
export default function Library() {
  return (
    <div className="max-w-3xl mx-auto px-4 lg:px-8 pt-6">
      ...
      <nav aria-label="Library sections" className="flex gap-2 mt-4 mb-4 overflow-x-auto no-scrollbar -mx-4 px-4">
        {TABS.map((t) => (
          <NavLink
            key={t.to}
            to={t.to}
            ...
            className={({ isActive }) =>
              `px-4 h-9 shrink-0 flex items-center rounded-full text-sm font-semibold transition-colors ${
